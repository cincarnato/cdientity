...
class Property extends \CdiCommons\Entity\BaseEntity {
     ...
     * @Annotation\Attributes({"type":"select","options":{"":"type","string":"string","stringarea":"stringarea","date":"date","datetime":"datetime","time":"time","text":"text","integer":"integer","boolean":"boolean","file":"file","oneToOne":"oneToOne","manyToOne":"manyToOne","oneToMany":"oneToMany","manyToMany":"manyToMany"}})
